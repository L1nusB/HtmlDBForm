...
try {
    ...
    $deleteAssignments = "DELETE FROM USEAP_RPA_Prozess_Zuweisung WHERE fk_RPA_Prozesse = ?";
    ...
    $deleteProcess = "DELETE FROM USEAP_RPA_Prozesse WHERE pk_RPA_Prozesse = ?";
    $stmt = sqlsrv_prepare($conn, $deleteProcess, array($data->id));
    ...
    echo json_encode([
        "status" => "success",
        "success" => true,
        "message" => "Process " . $data->processName . " deleted successfully"
    ]);
